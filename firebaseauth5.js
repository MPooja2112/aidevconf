...
const firebaseConfig = {
    apiKey: "AIzaSyAVTA4ylUfI7K0yLd1dV6ynhmjx8zTUEhg",
    authDomain: "speakerform-1e972.firebaseapp.com",
    projectId: "speakerform-1e972",
    storageBucket: "speakerform-1e972.firebasestorage.app",
    messagingSenderId: "1001812052971",
    appId: "1:1001812052971:web:72e8d4fbefac8a8d3527ae",
    measurementId: "G-X9GM4C29VS"
  };
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    signUpButton.addEventListener('click', async (event) => {
        ...
        if (!email || !password || !firstName || !lastName || !phoneNumber || !organization ||  !designation ||  !city || !state || !country) {
        ...
        try {
            ...
            await setDoc(doc(db, "speaker", user.uid), {
                email,
                firstName,
                lastName,
                phoneNumber,
